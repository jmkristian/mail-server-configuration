function rcube_init_settings_tabs(){var a,b;b=$("#tabsbar");var d=$("span",b).last(),c="#settingstabpreferences",e=window.rcmail&&rcmail.env.action?rcmail.env.action:null;if(d&&"settingstababout"!=d.attr("id")&&(a=$("#settingstababout")))b=a.clone(!0),a.remove(),d.after(b);e&&(c="#settingstab"+(0<e.indexOf("identity")?"identities":e.replace(/\./g,"")));$(c).addClass("tablink-selected");$("a",c).removeAttr("onclick").click(function(){return!1})}
function rcube_init_tabs(a,b){var d=$("#"+a),c=d.children("fieldset");if(c.length){b=b?b:0;var e=d.find(".tabsbar");e.length||(e=$("<div>").addClass("tabsbar").appendTo(d));c.each(function(d){var c,k,l=$(this),h=l.children("legend");l.is(":visible")&&!l.hasClass("tabbed")&&(k=$("<a>").text(h.text()).attr("href","#"),c=$("<span>").attr({id:"tab"+d,"class":"tablink"}).click(function(){rcube_show_tab(a,d);return!1}),h.remove(),l.addClass("tabbed"),d==b&&c.addClass("tablink-selected"),c.append(k).appendTo(e))});
